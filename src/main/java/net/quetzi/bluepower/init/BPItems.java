...
public class BPItems {
    ...
    public static void init() {
        ...
        sapphire_pickaxe = new ItemGemPickaxe(gemMaterial,
                Refs.SAPPHIREPICKAXE_NAME);
        ...
        malachite_sword = new ItemGemSword(gemMaterial,
                Refs.MALACHITESWORD_NAME);
        malachite_pickaxe = new ItemGemPickaxe(gemMaterial,
                Refs.MALACHITEPICKAXE_NAME);
        malachite_spade = new ItemGemSpade(gemMaterial,
                Refs.MALACHITESPADE_NAME);
        malachite_hoe = new ItemGemHoe(gemMaterial, Refs.MALACHITEHOE_NAME);
        malachite_sickle = new ItemSickle(gemMaterial,
                Refs.MALACHITESICKLE_NAME);
        ...
        diamond_sickle = new ItemSickle(ToolMaterial.EMERALD,
                Refs.DIAMONDSICKLE_NAME);
        
        flax_seed = new ItemCropSeed(BPBlocks.flax_crop, Blocks.farmland)
                .setUnlocalizedName(Refs.FLAXSEED_NAME);
    ...
    public static void registerItems() {
        ...
        // Todo: Add Ore dictionary here. ingotTin, ingotSilver etc. Also add
        // blocks
